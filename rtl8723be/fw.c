...
static void _rtl8723be_fw_page_write(struct ieee80211_hw *hw,
...
static void _rtl8723be_write_fw(struct ieee80211_hw *hw,
			     enum version_8723be version, u8 *buffer, u32 size)
{
	struct rtl_priv *rtlpriv = rtl_priv(hw);
	u8 *bufferPtr = (u8 *) buffer;
...
static void _rtl8723be_fill_h2c_command(struct ieee80211_hw *hw,
...
void rtl8723be_fill_h2c_cmd(struct ieee80211_hw *hw,
			 u8 element_id, u32 cmd_len, u8 *p_cmdbuffer)
{
	struct rtl_hal *rtlhal = rtl_hal(rtl_priv(hw));
	u32 tmp_cmdbuf[2];
	...
	_rtl8723be_fill_h2c_command(hw, element_id, cmd_len, (u8 *) & tmp_cmdbuf);
...
void rtl8723be_firmware_selfreset(struct ieee80211_hw *hw)
{
	...
	RT_TRACE(COMP_INIT, DBG_LOUD, ("  _8051Reset8723be(): 8051 reset success .\n"));
...
void rtl8723be_set_fw_pwrmode_cmd(struct ieee80211_hw *hw, u8 mode)
{
	...
	rtl8723be_fill_h2c_cmd(hw, H2C_88E_SETPWRMODE, H2C_88E_PWEMODE_LENGTH, u1_h2c_set_pwrmode);
...
void rtl8723be_set_fw_ap_off_load_cmd(struct ieee80211_hw *hw,  u8 ap_offload_enable)
{
	...
	rtl8723be_fill_h2c_cmd(hw, H2C_88E_AP_OFFLOAD, H2C_88E_AP_OFFLOAD_LENGTH, u1_apoffload_parm);
...
void rtl8723be_set_p2p_ctw_period_cmd(struct ieee80211_hw *hw, u8 ctwindow)
{
	...
	rtl8723be_fill_h2c_cmd(hw, H2C_88E_P2P_PS_CTW_CMD, 1, u1_ctwindow_period);
...
void rtl8723be_set_p2p_ps_offload_cmd(struct ieee80211_hw *hw, u8 p2p_ps_state)
{
	...
	rtl8723be_fill_h2c_cmd(hw, H2C_88E_P2P_PS_OFFLOAD, 1, (u8 *)p2p_ps_offload);
