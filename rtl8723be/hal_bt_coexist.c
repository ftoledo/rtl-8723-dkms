...
void rtl8723be_dm_bt_reject_ap_aggregated_packet(struct ieee80211_hw *hw, bool b_reject)
{
#if 0
...
u8 rtl8723be_dm_bt_check_coex_rssi_state1(struct ieee80211_hw *hw,
...

{
	...
	undecoratedsmoothed_pwdb =  rtl8723be_dm_bt_get_rx_ss(hw);
...
u8 rtl8723be_dm_bt_check_coex_rssi_state(struct ieee80211_hw *hw,
						u8	level_num, u8	rssi_thresh, u8 rssi_thresh1)
{
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
	struct rtl_priv *rtlpriv = rtl_priv(hw);
...
long rtl8723be_dm_bt_get_rx_ss(struct ieee80211_hw *hw)
{
	struct rtl_priv *rtlpriv = rtl_priv(hw);
	long undecoratedsmoothed_pwdb = 0;
	...
	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_get_rx_ss() = %ld\n", undecoratedsmoothed_pwdb));

	return undecoratedsmoothed_pwdb;
}

void rtl8723be_dm_bt_balance(struct ieee80211_hw *hw,
							bool b_balance_on, u8 ms0, u8 ms1)
{
	...
	rtl8723be_fill_h2c_cmd(hw, 0xc, 3, h2c_parameter);
}


void rtl8723be_dm_bt_agc_table(struct ieee80211_hw *hw, u8 type)
{
	struct rtl_priv *rtlpriv = rtl_priv(hw);
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
	...
	if (type == BT_AGCTABLE_OFF) {
		...
		rtl8723be_phy_set_rf_reg(hw, RF90_PATH_A,
...
void rtl8723be_dm_bt_bb_back_off_level(struct ieee80211_hw *hw, u8 type)
{
	struct rtl_priv *rtlpriv = rtl_priv(hw);
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
...
void rtl8723be_dm_bt_fw_coex_all_off(struct ieee80211_hw *hw)
{
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
	struct rtl_priv *rtlpriv = rtl_priv(hw);
	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_fw_coex_all_off()\n"));

	if(rtlpcipriv->btcoexist.b_fw_coexist_all_off)
		return;

	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_fw_coex_all_off(), real Do\n"));
	rtl8723be_dm_bt_fw_coex_all_off_8723a(hw);
	rtlpcipriv->btcoexist.b_fw_coexist_all_off = true;
}

void rtl8723be_dm_bt_sw_coex_all_off(struct ieee80211_hw *hw)
{
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
	struct rtl_priv *rtlpriv = rtl_priv(hw);

	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_sw_coex_all_off()\n"));

	if(rtlpcipriv->btcoexist.b_sw_coexist_all_off)
		return;

	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_sw_coex_all_off(), real Do\n"));
	rtl8723be_dm_bt_sw_coex_all_off_8723a(hw);
	rtlpcipriv->btcoexist.b_sw_coexist_all_off = true;
}

void rtl8723be_dm_bt_hw_coex_all_off(struct ieee80211_hw *hw)
{
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
	struct rtl_priv *rtlpriv = rtl_priv(hw);

	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_hw_coex_all_off()\n"));

	if(rtlpcipriv->btcoexist.b_hw_coexist_all_off)
		return;
	RT_TRACE(COMP_BT_COEXIST, DBG_TRACE,
		("rtl8723be_dm_bt_hw_coex_all_off(), real Do\n"));

	rtl8723be_dm_bt_hw_coex_all_off_8723a(hw);

	rtlpcipriv->btcoexist.b_hw_coexist_all_off = true;
}

void rtl8723be_btdm_coex_all_off(struct ieee80211_hw *hw)
{
	rtl8723be_dm_bt_fw_coex_all_off(hw);
	rtl8723be_dm_bt_sw_coex_all_off(hw);
	rtl8723be_dm_bt_hw_coex_all_off(hw);
}

bool rtl8723be_dm_bt_is_coexist_state_changed(struct ieee80211_hw *hw)
{
	struct rtl_pci_priv *rtlpcipriv = rtl_pcipriv(hw);
...
bool rtl8723be_dm_bt_is_wifi_up_link(struct ieee80211_hw *hw)
{
	struct rtl_priv *rtlpriv = rtl_priv(hw);
