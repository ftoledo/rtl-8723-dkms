...
#ifndef __rtl8723be_HAL_BT_COEXIST_H__
#define __rtl8723be_HAL_BT_COEXIST_H__
...
void rtl8723be_dm_bt_agc_table(struct ieee80211_hw *hw, u8 tyep);
...
void rtl8723be_dm_bt_reject_ap_aggregated_packet(struct ieee80211_hw *hw,
			bool b_reject);
