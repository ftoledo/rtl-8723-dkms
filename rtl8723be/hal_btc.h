...
#ifndef __rtl8723be_HAL_BTC_H__
#define __rtl8723be_HAL_BTC_H__
...
void rtl8723be_dm_bt_fw_coex_all_off_8723a(struct ieee80211_hw *hw);
void rtl8723be_dm_bt_sw_coex_all_off_8723a(struct ieee80211_hw *hw);
void rtl8723be_dm_bt_hw_coex_all_off_8723a(struct ieee80211_hw *hw);
void rtl8723be_dm_bt_coexist_8723(struct ieee80211_hw *hw);
void rtl8723be_dm_bt_set_bt_dm(struct ieee80211_hw *hw, struct btdm_8723 *p_btdm);
void rtl_8723be_c2h_command_handle(struct ieee80211_hw *hw);
void rtl_8723e_bt_wifi_media_status_notify(struct ieee80211_hw *hw, bool mstatus);
void rtl8723be_dm_bt_turn_off_bt_coexist_before_enter_lps(struct ieee80211_hw *hw);
