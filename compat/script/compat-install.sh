...
compat_wireless_version="3.5.4-1"
...
find $driver_fold -name '*.h' -print0 |xargs -0 sed -i 's/LINUX_VERSION_CODE/(KERNEL_VERSION(3,5,4))/g'
find $driver_fold -name '*.c' -print0 |xargs -0 sed -i 's/LINUX_VERSION_CODE/(KERNEL_VERSION(3,5,4))/g'
