...
/*#define REG_AFE_LDO_CTRL            0x0027*/ /* 1.5v for 8192EE test chip, 1.4v for MP chip */
...
#define	REG_HQ0_DESA				0x0340	/* TX High Queue  0 Descriptor Address*/
#define	REG_HQ1_DESA				0x0348	/* TX High Queue  1 Descriptor Address*/
#define	REG_HQ2_DESA				0x0350	/* TX High Queue  2 Descriptor Address*/
#define	REG_HQ3_DESA				0x0358	/* TX High Queue  3 Descriptor Address*/
#define	REG_HQ4_DESA				0x0360	/* TX High Queue  4 Descriptor Address*/
#define	REG_HQ5_DESA				0x0368	/* TX High Queue  5 Descriptor Address*/
#define	REG_HQ6_DESA				0x0370	/* TX High Queue  6 Descriptor Address*/
#define	REG_HQ7_DESA				0x0378	/* TX High Queue  7 Descriptor Address*/
...
/*Read Write Point*/
#define	REG_VOQ_IDX_DESC_INDEX		0x03A0
#define	REG_VIQ_IDX_DESC_INDEX		0x03A4
#define	REG_BEQ_IDX_DESC_INDEX		0x03A8
#define	REG_BKQ_IDX_DESC_INDEX		0x03AC
#define	REG_MGQ_IDX_DESC_INDEX		0x03B0
#define	REG_RXQ_IDX_DESC_INDEX		0x03B4

#define	REG_HI0Q_IDX_DESC_INDEX		0x03B8
#define	REG_HI1Q_IDX_DESC_INDEX		0x03BC
#define	REG_HI2Q_IDX_DESC_INDEX		0x03C0
#define	REG_HI3Q_IDX_DESC_INDEX		0x03C4

#define	REG_HI4Q_IDX_DESC_INDEX		0x03C8
#define	REG_HI5Q_IDX_DESC_INDEX		0x03CC
#define	REG_HI6Q_IDX_DESC_INDEX		0x03D0
#define	REG_HI7Q_IDX_DESC_INDEX		0x03D4
#define	REG_PCIE_HCPWM				0x03D8
#define	REG_PCIE_HRPWM				0x03DC	/*PCIe RPWM*/
...
#define	REG_MDIO					0x03F4	/* MDIO for Access PCIE PHY*/
#define	REG_MDIO_DATA				0x03F8	/* MDIO for Access PCIE PHY*/

/*#define	REG_DBI						0x0340
...
#define REG_BCN_PREDL_ITV			0x058F	/*Pre download beacon interval*/
...
/*      8723/8192E Host System Interrupt Mask Register (offset 0x58, 32 byte) */
...
/*
*       8723/8192E Host System Interrupt Status Register (offset 0x5C, 32 byte)
*/
...
#define	IMR_TIMER2				BIT(31)		/* Timeout interrupt 2	*/
#define	IMR_TIMER1				BIT(30)		/* Timeout interrupt 1	*/
