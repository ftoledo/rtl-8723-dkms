...
#define IS_HT_RATE(_rate)		(_rate >= DESC92C_RATEMCS0)
#define IS_CCK_RATE(_rate) 		(_rate >= DESC92C_RATE1M && _rate <= DESC92C_RATE11M)
#define IS_OFDM_RATE(_rate)		(_rate >= DESC92C_RATE6M && _rate <= DESC92C_RATE54M)
