...
u4Byte	GLCoexVerDate8192e2Ant=20130902;
u4Byte	GLCoexVer8192e2Ant=0x34;
...
halbtc8192e2ant_Decidera_mask(
	IN	PBTC_COEXIST		pBtCoexist,
	IN	u1Byte				ssType,
	IN	u4Byte				ra_maskType
	)
{
	u4Byte	disra_mask=0x0;
...
halbtc8192e2ant_LimitedRx(
	...
	IN	BOOLEAN				b_bt_ctrl_agg_buf_size,
	IN	u1Byte				aggBufSize
	)
{
	BOOLEAN	bRejectRxAgg=bRejApAggPkt;
	BOOLEAN	bBtCtrlRxAggSize=b_bt_ctrl_agg_buf_size;
